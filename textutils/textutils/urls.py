...
"""
'' states that what is the end point
second parameter states the function to be performed
third parameter states the name of path and can be accessed from anywhere
"""
